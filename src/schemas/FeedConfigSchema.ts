...
const FeedConfigCreateSchema = FeedConfigSchema.pick({ servo1Ms: true, servo2Ms: true, stepperMs: true, threshold: true })
const FeedConfigUpdateSchema = FeedConfigSchema.pick({ servo1Ms: true, servo2Ms: true, stepperMs: true, threshold: true }).partial()
