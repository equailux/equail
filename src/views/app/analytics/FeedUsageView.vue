		...
		<v-row no-gutters>
			<v-col>
				<v-card id="pdfContent" color="primary" elevation="0">
					...
					<template #subtitle>
						<span class="pb-0 text-subtitle-2 font-weight-regular"> Feed Production per month </span>
					</template>
					<template #text>
						<MonthlyFeedUsageChart class="w-100" :feed-usage-per-month></MonthlyFeedUsageChart>
					</template>
				</v-card>
			</v-col>
		</v-row>
