...
import type { ThresholdSchema, ThresholdUpdateSchema } from "@/schemas/ThresholdSchema"
import { ThresholdOp, ThresholdUpdateSchema as ThresholdUpdateFormSchema } from "@/schemas/ThresholdSchema"
...
const { handleSubmit, isSubmitting } = useForm({
	validationSchema: toTypedSchema(ThresholdUpdateFormSchema),
	initialValues: {
		name: props.threshold.name,
		icon: props.threshold.icon,
		message: props.threshold.message,
		operator: props.threshold.operator,
		activated: props.threshold.activated,
...
const { value: operator, errorMessage: operatorError } = useField<ThresholdSchema["operator"]>("operator")
